//#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#* Dta1xxCommon.h *#*#*#*#*#*#*#* (C) 2000-2011 DekTec
//
...
//-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- DTA1XX_AD9789_WRITE -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
//
// Data to write to AD9789 register
//
typedef struct _DTA1XX_AD9789_WRITE
{
    Int  m_PortIndex;               // Zero-based port index (0=first port, ...)
    Int  m_RegAddr;                 // Register address
    Int  m_NumToWrite;              // Number of bytes to write
    UInt8  m_Data[32];              // Data bytes, max. 32 bytes
} DTA1XX_AD9789_WRITE;
...
typedef struct _DTA1XX_FAILSAFE {
    Int  m_PortIndex;               // Zero-based port index (0=first port, ...)
    UInt  m_Mode;                   // 1 = Enable, 2 = Timeout, 3 = Enable+Timeout,
                                    // 4 = Alive
                                    // On a Get, Alive = on if application has responded
                                    // on time
...
//-.-.-.-.-.-.-.-.-.-.-.-.-.-.- DTA1XX_I2C_EXCL_ACCESS_INFO -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
//
typedef struct _DTA1XX_I2C_EXCL_ACCESS_INFO
{
    Int  m_Request;             // 0 = Request exclusive access
                                // 1 = Release exclusive access
    Int  m_Granted;             // 0 = In use
                                // 1 = Exclusive access granted
} DTA1XX_I2C_EXCL_ACCESS_INFO, *PDTA1XX_I2C_EXCL_ACCESS_INFO;
...
//.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- Spi clock -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-
typedef struct  _DTA1XX_SPI_CLK {
    Int  m_PortIndex;
    Int  m_SpiClkFreq;
} DTA1XX_SPI_CLK; 
...
typedef union _DTA1XX_IOCTL_DATA
{
...
#endif
    DTA1XX_AD9789_WRITE  m_Ad9789Write;     // Write to AD9789 register
    ...
    DTA1XX_I2C_EXCL_ACCESS_INFO  m_I2cExclAccess;  // I2C Exclusive-access info
    ...
    DTA1XX_SPI_CLK  m_SpiClk;               // Spi clock
...
enum {
    ...
    DTA1XX_FUNCTION_GET_OUTPUT_LEVEL,   // NOT USED - OBSOLETE
    DTA1XX_FUNCTION_SET_OUTPUT_LEVEL,   // NOT USED - OBSOLETE
    DTA1XX_FUNCTION_GET_RF_CONTROL,     // NOT USED - OBSOLETE
    DTA1XX_FUNCTION_SET_RF_CONTROL,     // NOT USED - OBSOLETE
    DTA1XX_FUNCTION_SET_RF_MODE,        // NOT USED - OBSOLETE
...
//
// InBuffer : DTA1XX_AD9789_WRITE
// OutBuffer: -
// Result   : BOOL
//
#if defined(WIN32) || defined(WIN64)
    // Windows
    #define IOCTL_DTA1XX_AD9789_WRITE                                             \
            CTL_CODE(DTA1XX_DEVICE_TYPE, DTA1XX_FUNCTION_AD9789_WRITE,            \
                     METHOD_BUFFERED, FILE_READ_DATA)
#else
    // Linux
    #define IOCTL_DTA1XX_AD9789_WRITE                                             \
            _IOW(DTA1XX_IOCTL_MAGIC, DTA1XX_FUNCTION_AD9789_WRITE,                \
                 DTA1XX_AD9789_WRITE)
#endif
...
//
// InBuffer : DTA1XX_I2C_EXCL_ACCESS_INFO
// OutBuffer: DTA1XX_I2C_EXCL_ACCESS_INFO
// Result   : BOOL
//
...
#if defined(WIN32) || defined(WIN64)
    // Windows
    #define IOCTL_DTA1XX_I2C_REQUEST_EXCL_ACCESS                                \
            CTL_CODE(DTA1XX_DEVICE_TYPE, DTA1XX_FUNCTION_I2C_REQ_EXCL_ACCESS,   \
                     METHOD_BUFFERED, FILE_ANY_ACCESS)
#else
    // Linux
    #define IOCTL_DTA1XX_I2C_REQUEST_EXCL_ACCESS                                \
            _IOWR(DTA1XX_IOCTL_MAGIC, DTA1XX_FUNCTION_I2C_REQ_EXCL_ACCESS,      \
                  DTA1XX_EXCL_ACCESS_INFO)
#endif
...
//-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- IOCTL_DTA1XX_SET_SPI_CLK -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-
//
// InBuffer : DTA1XX_SPI_CLK
// OutBuffer: -
// Result   : BOOL
//
// Force speed for ethernet
...
#if defined(WIN32) || defined(WIN64)
    // Windows
    #define IOCTL_DTA1XX_SET_SPI_CLK                                          \
            CTL_CODE(DTA1XX_DEVICE_TYPE, DTA1XX_FUNCTION_SET_SPI_CLK,         \
                     METHOD_BUFFERED, FILE_READ_DATA)
#else
    // Linux
    #define IOCTL_DTA1XX_SET_SPI_CLK                                          \
            _IOWR(DTA1XX_IOCTL_MAGIC, DTA1XX_FUNCTION_SET_SPI_CLK,            \
                  DTA1XX_SPI_CLK)
#endif
...
//
// Successor of IOCTL_DTA1XX_SET_TS_RATE2 for modulators
//
// InBuffer : DTA1XX_RATE_INFO2
// OutBuffer: -
// Result   : BOOL
//
// Set a modulator's rate without modulation-tupe specific processing
//
#if defined(WIN32) || defined(WIN64)
    // Windows
    #define IOCTL_DTA1XX_SET_RATE3                                              \
            CTL_CODE(DTA1XX_DEVICE_TYPE, DTA1XX_FUNCTION_SET_RATE3,             \
                     METHOD_BUFFERED, FILE_READ_DATA)
#else
    // Linux
    #define IOCTL_DTA1XX_SET_RATE3                                              \
            _IOWR(DTA1XX_IOCTL_MAGIC, DTA1XX_FUNCTION_SET_RATE3,                \
                  DTA1XX_RATE_INFO2)
#endif
...
//.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- I/O Configuration -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-
// I/O ConfigCode
#define  DTA1XX_IOCONFIG_CODES      0x80000000
#define  DTA1XX_IOCONFIG_IOCONFIG   (1 | DTA1XX_IOCONFIG_CODES)
#define  DTA1XX_IOCONFIG_TSRATESEL  (2 | DTA1XX_IOCONFIG_CODES)
#define  DTA1XX_IOCONFIG_SPIMODE    (3 | DTA1XX_IOCONFIG_CODES)
#define  DTA1XX_IOCONFIG_SPICLKSEL  (4 | DTA1XX_IOCONFIG_CODES)
#define  DTA1XX_IOCONFIG_SPISTD     (5 | DTA1XX_IOCONFIG_CODES)
...
// ConfigCode DTA1XX_IOCONFIG_TSRATESEL
#define  DTA1XX_TSRATESEL_INTERNAL  0 // Default clock for this port
#define  DTA1XX_TSRATESEL_EXTCLK    1 // Clock from external clock input
#define  DTA1XX_TSRATESEL_EXTRATIO  2 // Clock from external with ratio
#define  DTA1XX_TSRATESEL_LOCK2INP  3 // Clock from port <parXtra>

// ConfigCode DTA1XX_IOCONFIG_SPIMODE
#define  DTA1XX_SPIMODE_STANDARD    0 // DVB-SPI (DVB-ASI), BT.656 27 MHz
#define  DTA1XX_SPIMODE_FIXEDCLK    1 // DVB fixed-clock mode, BT.656 variable clock
#define  DTA1XX_SPIMODE_SERIAL8B    2 // DVB 8-bit serial on parallel port
#define  DTA1XX_SPIMODE_SERIAL10B   3 // DVB 10-bit serial on parallel port

// ConfigCode DTA1XX_IOCONFIG_SPICLKSEL
#define  DTA1XX_SPICLKSEL_INTERNAL  0
#define  DTA1XX_SPICLKSEL_EXTCLK    1

// ConfigCode DTA1XX_IOCONFIG_SPISTD
#define  DTA1XX_SPISTD_LVDS1         0
#define  DTA1XX_SPISTD_LVDS2         1
#define  DTA1XX_SPISTD_LVTTL         2
...
#define  DTA1XX_TXCLOCK_LOCK2INP    2
...
#define  DTA1XX_TXMODE_TIMESTAMP    0x400
