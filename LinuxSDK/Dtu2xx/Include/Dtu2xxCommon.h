//#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#* Dtu2xxCommon.h *#*#*#*#*#*#*#* (C) 2000-2010 DekTec
//
...
//-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- DTU2XX_AD9789_WRITE -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
//
// Data to write to AD9789 register (on DTU-215)
//
typedef struct _DTU2XX_AD9789_WRITE
{
    ...
    UInt8  m_Data[32];          // Data bytes, max. 32bytes
} DTU2XX_AD9789_WRITE;
...
//.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- DTU2XX_FIFO_EXTRAP -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
//
// Parameters used for FIFO-load extrapolation
//
typedef struct _DTU2XX_FIFO_EXTRAP
{
    Int  m_PortIndex;           // Zero-based port index (0=first port, ...)
    Int  m_EnaFifoLoadExtrap;   // Enable FIFO-load extrapolation
    Int  m_NumTxBytesPerSec;    // Number of bytes transmitted per second
} DTU2XX_FIFO_EXTRAP;
...
typedef struct _DTU2XX_I2C_TRANSFER
{
    ...
    UInt8  m_DataBuf[DTU2XX_I2C_BUF_SIZE];
} DTU2XX_I2C_TRANSFER;
...
// Can be obsoleted in new DTAPI/Driver structure
//
...
//-.-.-.-.-.-.-.- DTU2XX_RW_INFO (for 32-bit application on 64-bit Linux) -.-.-.-.-.-.-.-.
//
...
typedef struct _DTU2XX_VPD_EEPROM
{
    ...
    UInt  m_Length;             // Number of BYTES
    UInt8  m_VpdBuf[DTU2XX_VPD_BUF_SIZE];          // The Vital product data itself
} DTU2XX_VPD_EEPROM;
...
typedef struct _DTU2XX_VPD_ITEM
{
    ...
    UInt8  m_VpdBuf[DTU2XX_VPD_ITEM_MAX_LENGTH+1]; // The Vital product data itself
} DTU2XX_VPD_ITEM;
...
//.-.-.-.-.-.-.- DTU2XX_REG_WRITE_MASKED - Masked write to device register -.-.-.-.-.-.-.-
//
typedef struct _DTU2XX_REG_WRITE_MASKED
{
    Int  m_PortIndex;           // Zero-based port index (0=first port, ...)
    Int  m_RegAddr;             // Register address
    Int  m_FieldMask;           // AND-mask to get field value in register
    Int  m_FieldShift;          // Position of field in register (#times to shift left)
    Int  m_FieldValue;          // Value to write in field
} DTU2XX_REG_WRITE_MASKED;
...
{
    DTU2XX_AD9789_WRITE             m_Ad9789Write;      // Write to AD9789 register
    DTU2XX_DRIVER_VERSION           m_DriverVersion;    // Versioning info
    DTU2XX_DVC_INFO                 m_DevInfo;          // Device information
    DTU2XX_EEPROM_CONTROL           m_EepromControl;    // Special EEPROM control
    DTU2XX_EXCL_ACCESS_INFO         m_ExclAccess;       // Exclusive-access info
    DTU2XX_FIFO_EXTRAP              m_FifoExtrap;       // FIFO load extrapolation pars
    ...
    DTU2XX_REG_WRITE_MASKED         m_RegWriteMasked;   // Masked write to device register
...
// - DON'T CHANGE SEQUENCE OF IOCTL FUNCTION CODES
...
enum {
    ...
    DTU2XX_TX_FUNCTION_AD9789_WRITE,
    DTU2XX_TX_FUNCTION_REG_WRITE_MASKED,
    DTU2XX_TX_FUNCTION_SET_FIFO_EXTRAP
};
...
//-.-.-.-.-.-.-.-.-.-.-.-.-.-.- IOCTL_DTU2XX_TX_AD9789_WRITE -.-.-.-.-.-.-.-.-.-.-.-.-.-.-
//
// InBuffer : DTU2XX_AD9789_WRITE
// OutBuffer: -
// Result   : BOOL
//
#if defined(WIN32) || defined(WIN64)
    // Windows
    #define IOCTL_DTU2XX_TX_AD9789_WRITE                                          \
            CTL_CODE(DTU2XX_DEVICE_TYPE, DTU2XX_TX_FUNCTION_AD9789_WRITE,         \
                     METHOD_BUFFERED, FILE_READ_DATA)
#else
    // Linux
    #define IOCTL_DTU2XX_TX_AD9789_WRITE                                          \
            _IOW(DTU2XX_IOCTL_MAGIC, DTU2XX_TX_FUNCTION_AD9789_WRITE,             \
                 DTU2XX_AD9789_WRITE)
#endif
...
//-.-.-.-.-.-.-.-.-.-.-.-.-.- IOCTL_DTU2XX_TX_REG_WRITE_MASKED -.-.-.-.-.-.-.-.-.-.-.-.-.-
//
// InBuffer : DTU2XX_REG_MASKED_WRITE
// OutBuffer: -
// Result   : BOOL
//
#if defined(WIN32) || defined(WIN64)
    // Windows
    #define IOCTL_DTU2XX_TX_REG_WRITE_MASKED                                         \
            CTL_CODE(DTU2XX_DEVICE_TYPE, DTU2XX_TX_FUNCTION_REG_WRITE_MASKED,        \
                     METHOD_BUFFERED, FILE_READ_DATA)
#else
    // Linux
    #define IOCTL_DTU2XX_TX_REG_WRITE_MASKED                                         \
            _IOW(DTU2XX_IOCTL_MAGIC, DTU2XX_TX_FUNCTION_REG_WRITE_MASKED,            \
                 DTU2XX_REG_WRITE_MASKED)
#endif
...
//-.-.-.-.-.-.-.-.-.-.-.-.-.- IOCTL_DTU2XX_TX_SET_FIFO_EXTRAP -.-.-.-.-.-.-.-.-.-.-.-.-.-.
//
// InBuffer : DTU2XX_FIFO_EXTRAP
// OutBuffer: -
// Result   : BOOL
//
...
#if defined(WIN32) || defined(WIN64)
    // Windows
    #define IOCTL_DTU2XX_TX_SET_FIFO_EXTRAP                                     \
            CTL_CODE(DTU2XX_DEVICE_TYPE, DTU2XX_TX_FUNCTION_SET_FIFO_EXTRAP,    \
                     METHOD_BUFFERED, FILE_READ_DATA)
#else
    // Linux
    #define IOCTL_DTU2XX_TX_SET_FIFO_EXTRAP                                     \
            _IOW(DTU2XX_IOCTL_MAGIC, DTU2XX_TX_FUNCTION_SET_FIFO_EXTRAP,        \
                 DTU2XX_FIFO_EXTRAP)
#endif
